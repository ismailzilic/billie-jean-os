...
./bin/kernel.bin: $(FILES)
	...
	i686-elf-gcc $(FLAGS) -T ./src/linker.ld -o ./build/kernel.elf ./build/kernelfull.o
...
debug: all
	qemu-system-i386 -drive file=./bin/os.bin,format=raw -S -s

gdb:
	gdb ./build/kernel.elf -ex "set architecture i386" -ex "target remote :1234"
